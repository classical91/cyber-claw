...
function buildHelpReport() {
  return createReport(
    "Command Library",
    "Use the console like an operator surface. These commands are wired into the prototype right now.",
    "low",
    [
      {
...
function buildUnknownReport(command) {
  return createReport(
    ...
    `The console does not understand "${command}" yet, but the prototype is ready for perimeter, network, front-door, and arm-state workflows.`,
    "medium",
    [
      {
...
export function createState(options = {}) {
  ...
  return seed === "blank" ? syncState(createBlankState()) : createSampleState();
}
